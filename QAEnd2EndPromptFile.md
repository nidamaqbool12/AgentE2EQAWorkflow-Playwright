...
### Prompt:
> I need to start a new testing workflow. Please read the user story from the file: `User_stories/SCRUM-101-ecommerce-checkout.md`
> 
...
### Prompt:
> Based on the user story checkout that we just reviewed, use the `playwright-test-planner` agent to:
> 
...
**Git Repository URL:** `https://github.com/nidamaqbool12/AgentE2EQAWorkflow-Playwright.git`
